...
这个例子 index 是从0开始的，第一次的 prev 的值是我们设置的初始值0，数组长度是4，reduce 函数循环4次。
...
但是要是按照例2设置了初始值就不会报错。**所以一般来说我们提供初始值通常更安全**
...
【1】[JS数组reduce()方法详解及高级技巧](https://www.jianshu.com/p/e375ba1cfc47)
